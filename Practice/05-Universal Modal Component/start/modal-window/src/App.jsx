...
function App() {
  ...
  return (
    <div className="app">
      <Main isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} closeModal={closeModal} alertCloseModal={alertCloseModal} openModal={openModal}>
        <Modal closeModal={closeModal} alertCloseModal={alertCloseModal} title={"Confirm Your Action"} content={"Are you sure you want to proceed? This action cannot be undone."} showButton>
          <Button handleClick={closeModal} className={"closeButton"}>&times;</Button>
          <Button handleClick={closeModal} className={"secondaryButton"}>Cancel</Button>
          <Button handleClick={alertCloseModal} className={"primaryButton"}>Yes, Continue</Button>
        </Modal>
        </Main>
    </div>
  );
